set in_dcp "/home/cian/Masterproef/project/results/run_lut_insertion/TestDirectory/phase6b2_full_eco_patch1/phase6b2_eco_unrouted.dcp"
set out_dir "/home/cian/Masterproef/project/results/run_lut_insertion/TestDirectory/phase6b2_full_eco_patch2_fresh_route"
set out_dcp "$out_dir/phase6b2_eco_routed_fresh.dcp"
...
# Gebruik eerst volledige route_design, niet -preserve.
# Reden: de vorige routed writeback crashte bij reload.
# Full route geeft Vivado de kans om een consistente routed database te schrijven.
